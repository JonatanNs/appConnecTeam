...
import { faCircleQuestion, faGear, faMagnifyingGlass, faRightFromBracket, faShieldHalved, faUser, faXmark,
         faBars, faHouse, faNewspaper, faComments, faAddressBook, faUsers } from '@fortawesome/free-solid-svg-icons';
